            ...
            <div class="col-12">
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        {!! Form::model($telco, ['method' => 'PATCH','route' => ['mtopup.telcopostupdate', $telco->id]]) !!}
                        <div class="card-body row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="number_format" type="text" class="form-control" id="number_format" placeholder="Enter Number Format" value="{{ $telco->number_format or old('number_format') }}">
                                </div>
