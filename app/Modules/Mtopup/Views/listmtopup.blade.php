...
<script>
    $(document).ready(function(){
        $("tr.irow").click(function(){
            ...
            $.get( "/admin/ajax/mtopup/"+id, function( data ) {
                $( "#MtopupAjaxContent" ).html( data );
            });
            $("#MtopupModal").modal();
        });
    });
...
<div class="modal fade" id="MtopupModal" tabindex="-1" role="dialog" aria-labelledby="MtopupModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div id="MtopupAjaxContent"></div>
        </div>
    </div>
</div>
    <!-- Main content -->
                            ...
                            <div class="row"><div class="col-sm-12">
                                    <table id="tablez" class="table table-bordered table-striped">
                                        ...
                                        @foreach( $listmtopups as $listmtopup )
                                            <tr class="irow" data-id="{{ $listmtopup->id }}">
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($listmtopup->status == 'none')
                                                        <label class="badge badge-secondary">NONE</label>
                                                    @elseif($listmtopup->status == 'wrong')
                                                        <label class="badge badge-danger">WRONG</label>
                                                ...
                                                <td> <span class="badge @if ($listmtopup->payment_status == 'paid') bg-primary @else bg-danger @endif">{{ $listmtopup->payment_status  }}</span></td>
                                                <td>@if ($listmtopup->mix == 1) <span class="badge bg-primary">yes</span> @else <span class="badge bg-warning">no</span> @endif</td>
