...
<div class="card">
  ...
  <div class="card-header" style="border-bottom: 0">
    <h3 class="card-title float-left">Roles Management</h3>
    <div class="float-right" style="margin-right: 150px">
      <a href="{{ url($backendUrl.'/roles/create') }}"><button class="btn btn-success"><i class="fa fa-plus-circle"></i> Add Role</button></a>
    </div>
        ...
        <tr>
          ...
          <td>
            <div class="action-buttons">
             <a href="{{ url($backendUrl.'/roles/'.$role->id.'/edit') }}"> <i title="Sửa" class="ace-icon fa fa-pencil bigger-130"></i> </a>  | 

             <a href="#" name="{{ $role->name }}" link="{{ url($backendUrl.'/roles/'.$role->id) }}" class="deleteClick red id-btn-dialog2"data-toggle="modal" data-target="#deleteModal" > <i title="Delete" class="ace-icon fa fa-trash-o bigger-130"></i></a>
