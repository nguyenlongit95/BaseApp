  ...
  $(document).ready(function(){
    $('body').on('click','.menu-item-action-btn',function(e){
      ...
      if(confirmText=='' || actionConfirm==true){
        $.ajax({
          url: '{{ route("categories.ajaxitemaction") }}',
          method: 'POST',
    ...
    $('body').on('click','.render-new-form',function(e){
      e.preventDefault();
      $.ajax({
        url: '{{ route("categories.ajaxrenderform") }}',
        method: 'POST',
        data: {form:'new'},
        beforeSend:function(){
          $('#form-message').html('');
    ...
    <div class="col-sm-6 col-md-6">
      <div class="card card-primary">
        <div class="card-header" style="">
          <h3 class="card-title">Categories tree</h3>
          <div class="float-right">
            <a href="#"><button class="btn btn-success btn-sm render-new-form"><i class="fa fa-plus-circle"></i> Add New Category</button></a>
          </div>
        </div>
      ...
      <div class="card card-primary card-menu-form">
        ...
        <div class="card-body">
          <div id="form-message"></div>
            {!! Form::open(array('route' => 'categories.store','method'=>'POST','id'=>'menu-form')) !!}
