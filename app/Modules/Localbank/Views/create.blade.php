                ...
                <div class="card-body row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input name="code" type="text" class="form-control" id="code" placeholder="Ví dụ: Vietcombank" value="{{ old('code') }}" >
                    </div>
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input name="icon" type="text" class="form-control" id="icon" placeholder="icon" value="{{ old('icon') }}">
                    </div>
                    <div class="form-group">
