...
<div class="card">
  ...
  <div class="card-header" style="border-bottom: 0">
    ...
    <div class="float-right" style="margin-right: 150px">
      <a href="{{ url($backendUrl.'/users/create') }}"><button class="btn btn-success"><i class="fa fa-plus-circle"></i> Add User</button></a>
    </div>
  ...
  <!-- /.card-header -->
  <form action="{{ url($backendUrl.'/users') }}" method="POST">
        ...
        <tr>
          ...
          <td>
            <div class="action-buttons">
             <a href="{{ url($backendUrl.'/users/'.$user->id.'/edit') }}"> <i title="Sửa" class="ace-icon fa fa-pencil bigger-130"></i> </a>  | 

             <a href="#" name="{{ $user->name }}" link="{{ url($backendUrl.'/users/'.$user->id) }}" class="deleteClick red id-btn-dialog2"data-toggle="modal" data-target="#deleteModal" > <i title="Delete" class="ace-icon fa fa-trash-o bigger-130"></i></a>
