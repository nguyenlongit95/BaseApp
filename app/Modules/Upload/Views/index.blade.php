...
<!-- Your Page Content Here -->
    <form action="{{ url($backendUrl.'/uploads/upload_files') }}" id="fm_dropzone_main" enctype="multipart/form-data" method="POST" class="dz-clickable" style="display: none;">
        {{ csrf_field() }}
        <a id="closeDZ1"><i class="fa fa-times"></i></a>
        <div class="dz-message"><i class="fa fa-cloud-upload"></i>
            <br>Drop files here to upload</div>
    </form>
                ...
                <div class="modal-body p0">
                    <div class="row m0">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <form method="POST" action="/admin/uploads/uploads" accept-charset="UTF-8" class="file-info-form">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="public" type="checkbox" value="public" style="display: none;">
...
$(function () {
    ...
    $("body").on("click", "ul.files_container .fm_file_sel", function() {
        ...
        $.ajax({
            url: "/admin/uploads/uploads_update_public",
            method: 'POST',
        ...
        // TODO: Update Caption
        $.ajax({
            url: "{{ url($backendUrl.'/uploads/uploads_update_caption') }}",
            method: 'POST',
            data: $("form.file-info-form").serialize(),
            success: function( data ) {
                console.log(data);
        ...
        $.ajax({
            url: "/admin/uploads/uploads_update_filename",
            method: 'POST',
            data: $("form.file-info-form").serialize(),
            success: function( data ) {
                console.log(data);
        ...
        if(confirm("Delete image "+$(".file-info-form input[name=filename]").val()+" ?")) {
            $.ajax({
                url: "/admin/uploads/uploads_delete_file",
                method: 'POST',
                data: $("form.file-info-form").serialize(),
                success: function( data ) {
                    console.log(data);
...
function loadUploadedFiles() {
    ...
    $.ajax({
        dataType: 'json',
        url: "/admin/uploads/uploaded_files",
