                ...
                <div class="card">
                    ...
                    <div class="card-header" style="border-bottom: 0">
                        ...
                        <div class="float-right" style="">
                            <a href="{{ url($backendUrl.'/chargings/history') }}"><button class="btn btn-success"><i class="fa fa-history" aria-hidden="true"></i> History Charging</button></a>
                            <a href="{{ url($backendUrl.'/chargings/settings') }}"><button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Settings</button></a>
                        </div>
                    </div>
                    <!-- /.card-header -->
