...
class AutoCharging
{
    ...
    const URL_POST = 'http://localhost/webthe/public/autochargingws.html'; // URL nay la URL phia nha mang cung cap
    ...
    public function check_card($telco, $code, $serial, $request_id)
    {
        $params = new stdClass();
        ...
        $params->sign = md5($params->partner_id.$params->partner_key.$params->telco.$params->code.$params->serial.$params->request_id);
